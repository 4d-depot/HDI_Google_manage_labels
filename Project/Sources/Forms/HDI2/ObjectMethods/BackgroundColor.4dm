If (FORM Event:C1606.code=On Clicked:K2:4)
	...
	$form:={index: Form:C1466.backgroundColor}
	DIALOG:C40("ColorPicker"; $form)
	CLOSE WINDOW:C154
	
	Form:C1466.backgroundColor:=$form.index
	...
	Form:C1466.backgroundColorPicture:=cs:C1710.SVGCreator.new().icon($colorList.getHexa(Form:C1466.backgroundColor); $colorList.getHexa(Form:C1466.backgroundColor))
End if 