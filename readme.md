# HDI_Google_manage_labels 

Use NetKit to manage Gmail labels (4D v20 R4) 

Find more information on the [blog post](https://blog.4d.com/4d-netkit-create-delete-and-update-gmail-labels/).
